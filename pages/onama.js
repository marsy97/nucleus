...
function Omeni(){
    ...
    <div className="container">
        ...
        <div className="slikeomeni">
            <div className="slika">
                <Image src="/zastoja1.jpg" width={300} height={300} alt="" />
                <p>Trening s klijentom</p>
            </div>


            <div className="slika">
                <Image src="/zastoja2.jpg"width={300} height={300} alt="" />
            ...
            <div className="slika">
                <Image src="/zastoja3.jpg" width={300} height={300} alt=""/>
        ...
        <div className="certifikati">
            ...
            <Image src="/certifikat1.jpg" width={300} height={300} alt="" />
            <Image src="/certifikat2.jpg" width={300} height={300} alt=""/>
        </div>
